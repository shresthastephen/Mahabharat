            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-emerald-100">Lakeside, Pokhara</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-emerald-100">+977-61-567893</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-emerald-100">10:30 AM - 9:30 PM</div>
                </div>
              </div>
            </div>
          </div>
