...
const BranchSection = () => {
  ...
  return (
    <section id="branches" className="py-20 bg-gradient-to-br from-yellow-50 to-amber-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {branches.map((branch) => (
            ...
            >
              {branch.isMain && (
                <div className="absolute top-4 left-4 bg-yellow-600 text-white px-3 py-1 rounded-full text-sm font-semibold z-10">
                  Main Branch
                </div>
              )}
