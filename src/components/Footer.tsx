        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Online Order</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Steamed Momos</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Fried Momos</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Jhol Momos</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Chow Mein</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Thukpa</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-500 transition-colors">Sel Roti</a></li>
            </ul>
          </div>
